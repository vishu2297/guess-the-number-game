...
function checkNumber() {
  ...
  if(!validateInput(userInput)) {
    msg.innerHTML = "<p class='text-danger'>Number should be 4-digit long in Integer</p>";
    return;
  } else {
    msg.innerHTML = "";
    attempt++;
  ...
  if(answer === userInput) {
    ...
    msg.innerHTML = "<p class='text-danger'>Sorry, You lost the game. Please play again to win. </p>";
    document.getElementById("btn-guess").style = "display:none;";
    document.getElementById("btn-replay").style = "display:block;";
  } else {
